...
const sharedComponentTokens = (
  ...
  bottomNavigation: {
    background: `color-mix(in srgb, ${semantic.actionPrimary} 60%, transparent)`,
    border: `color-mix(in srgb, ${semantic.elevatedSurface} 44%, transparent)`,
    activeBackground: `color-mix(in srgb, ${semantic.elevatedSurface} 18%, transparent)`,
    itemActive: semantic.textOnPrimary,
    itemInactive: `color-mix(in srgb, ${semantic.textOnPrimary} 78%, transparent)`,
    indicator: semantic.textOnPrimary,
  },
  toast: {
    background: semantic.elevatedSurface,
    text: semantic.textPrimary,
...
export const themeDefinitions: Record<ThemeId, ThemeDefinition> = {
  ...
  "san-pedro": buildTheme({
    ...
    semantic: {
      ...
      textMuted: "#6f5d4c",
      actionPrimary: "#a33f22",
      actionPrimaryHover: "#82321b",
      actionSecondary: "#0f6765",
      borderSubtle: "#e2cfb6",
      divider: "#ebddc9",
      focusRing: "#0c5553",
      success: "#2f8f61",
